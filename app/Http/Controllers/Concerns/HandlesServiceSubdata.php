...
/**
 * Shared service sub-table logic used by both the vendor self-serve flow
 * (VendorServiceController) and the admin-on-behalf flow (AdminVendorSetupController).
 * Single source of truth for per-category save/load + draft-service creation.
 */
trait HandlesServiceSubdata
{
    /**
     * Auto-create a draft service from a vendor's onboarding data when they have
     * none yet. No-op if a service already exists or onboarding isn't complete.
     */
    protected function ensureServiceForVendor(User $vendor): void
    {
        if (Service::where('vendor_id', $vendor->id)->exists()) {
            return;
        }
    ...
    protected function loadSubData(Service $service): void
    {
    ...
    // ── Dispatch sub-table save for a service by category slug ────────────
    protected function saveServiceSubdata(Service $service, array $d): void
    {
        $slug = $service->category->slug ?? '';
    ...
    protected function saveVenue(int $sid, array $d): void
    {
    ...
    protected function saveCatering(int $sid, array $d): void
    {
    ...
    protected function saveFlorist(int $sid, array $d): void
    {
    ...
    protected function saveCarHire(int $sid, array $d): void
    {
    ...
    protected function savePhotography(int $sid, array $d): void
    {
    ...
    protected function saveMusic(int $sid, array $d): void
    {
    ...
    protected function saveBrideDress(int $sid, array $d): void
    {
    ...
    protected function saveGroomSuite(int $sid, array $d): void
    {
    ...
    protected function saveBestManSuit(int $sid, array $d): void
    {
    ...
    protected function saveBridesmaid(int $sid, array $d): void
    {
    ...
    protected function saveFlowerGirl(int $sid, array $d): void
    {
    ...
    protected function saveYacht(int $sid, array $d): void
    {
    ...
    protected function saveBachelor(int $sid, array $d): void
    {
    ...
    protected function saveBachelorette(int $sid, array $d): void
    {
    ...
    protected function saveHotel(int $sid, array $d): void
    {
    ...
    protected function saveBar(int $sid, array $d): void
    {
    ...
    protected function saveMakeup(int $sid, array $d): void
    {
    ...
    protected function saveHair(int $sid, array $d): void
    {
        $mode = in_array($d['pricing_mode'] ?? '', ['packages', 'regular']) ? $d['pricing_mode'] : 'regular';
    ...
    protected function saveInvitation(int $sid, array $d): void
    {
