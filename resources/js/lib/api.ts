...
export const adminApi = {
  ...
  activatePlan: (id: number, plan: string) => api.post(`/admin/users/${id}/activate-plan`, { plan }).then((r) => r.data),
  changeRole: (id: number, role: string) => api.patch(`/admin/users/${id}/role`, { role }).then((r) => r.data),
