...
const PATHS: Record<string, React.ReactNode> = {
  ...
  nail: <><path d="M9.5 3h5v3h-5z"/><path d="M10 6h4a1 1 0 0 1 1 1v12a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2V7a1 1 0 0 1 1-1Z"/><path d="M9 12h6"/></>,
  dance: <><circle cx="14" cy="4.5" r="1.6"/><path d="M14 6.5 12 12l4 3"/><path d="M12 12 7.5 10 5 14"/><path d="m12 12-1.5 9"/><path d="M12.5 15.5 16 21"/></>,
  ...
  twitter: <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.45-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117l11.966 15.644Z" fill="currentColor" stroke="none"/>,
  ...
  yacht: <><path d="M12 3.2V14"/><path d="M13.6 5.2 19 14h-5.4z"/><path d="M10.4 7 6 14h4.4z"/><path d="M3.5 17h17l-2.3 3.2a1.6 1.6 0 0 1-1.3.6H7.1a1.6 1.6 0 0 1-1.3-.6z"/></>,
  ...
  catering: <><path d="M2 18.5h20"/><path d="M3 18.5a9 9 0 0 1 18 0"/><path d="M12 9.5V7.6"/><circle cx="12" cy="6.4" r="1.1"/></>,
  florist: <><path d="M12 13.2c-3.4 0-5.2-2.5-5.2-5.7 1.9 0 3.4.8 4.2 2C11.3 7.6 12 6 12 6s.7 1.6 1 3.5c.8-1.2 2.3-2 4.2-2 0 3.2-1.8 5.7-5.2 5.7Z"/><path d="M12 13.2V21"/><path d="M12 17.4c-2.5 0-3.8-1.3-3.8-2.8 2 0 3.8 1 3.8 2.8Z"/></>,
  suit: <><path d="M9 3 5.4 4.8A2 2 0 0 0 4.3 6.6L4 21"/><path d="M15 3l3.6 1.8a2 2 0 0 1 1.1 1.8L20 21"/><path d="M9 3v2.6L12 9.4l3-3.8V3"/><path d="M12 9.4V21"/><path d="M4 21h16"/></>,
  dress: <><path d="M9.6 3 12 5.4 14.4 3"/><path d="M9.6 3v2.6L8.4 9.2h7.2L14.4 5.6V3"/><path d="M8.4 9.2 4.5 19.7c2.1 1.2 4.6 1.8 7.5 1.8s5.4-.6 7.5-1.8L15.6 9.2"/></>,
  'bridesmaid-dress': <><path d="M10 3 12 5.2 14 3"/><path d="M10 3v2.8L8.8 9.6h6.4L14 5.8V3"/><path d="M8.8 9.6 6.6 20.8h10.8L15.2 9.6"/><path d="M8.25 12.4h7.5"/></>,
  ...
  makeup: <><path d="M10 7.4V3.6l4-1.4v5.2z"/><path d="M9.2 7.4h5.6v3H9.2z"/><path d="M9.8 10.4h4.4v9.8a1.2 1.2 0 0 1-1.2 1.2h-2a1.2 1.2 0 0 1-1.2-1.2z"/></>,
